...
//         rating,id:newId,
//         camera,description}=cart
//     return (
//         <div className='w-4xl bg-amber-100 p-8 shadow-2xl flex justify-between gap-10 mb-10'>
...
//     </div>
// <div className='text-2xl text-red-600 flex items-center'><MdDeleteForever /></div>
//         </div>
//     );
// };
